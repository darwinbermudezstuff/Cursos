...
namespace Storage.Controllers.Administration
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult CategoryView(bool successful = false, string ResultAction = "")
        {
            ...
            model.CellarAreaList = CellarAreaBussines.Select.GetCellarAreaList().CellarAreaList;
        ...
        public ActionResult CategoryCreate()
        {
            ...
            modal.CellarAreaList = CellarAreaBussines.Select.GetCellarAreaList().CellarAreaList;
