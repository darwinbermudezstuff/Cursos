                ...
                try
                {
                    ...
                    if (!bussines.Item1.Error)
                    {
                        response.Transaction = new Transactions()
                        {
                            ...
                            idConditionProduct = bussines.Item2.TidConditionProduct,
                            expeditionDate = bussines.Item2.TexpeditionDate,
                    ...
                    if (!bussines.Item1.Error)
                    {
                        foreach (var item in bussines.Item2) {
                            response.TransactionList.Add(new Transactions() {
                                ...
                                detail = item.Tdetail,
                                expeditionDate = item.TexpeditionDate,
                                idConditionProduct = item.TidConditionProduct,
        ...
        public class Insert
        {
            ...
            public static GetTransactionConfigurateResponse TransactionConfigurate(int AnchorTransactionID, int TransactionTypeID, Transactions Transaction)
            {
                ...
                try
                {
                    ...
                    ConditionDetail(TransactionTypeID, AnchorTransactionID, (int)Transaction.idConditionProduct, (int)Transaction.amount);
