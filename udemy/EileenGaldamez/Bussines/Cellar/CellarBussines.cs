...
namespace Bussines.Cellar
{
    ...
    public class CellarBussines
    {
        ...
        public class Select
        {
            ...
            public static GetCellarResponse GetCellarToArea(int CellarArea)
            {
                GetCellarResponse response = new GetCellarResponse();
                response.CellarList = new List<Cellars>();
                response.Error = new Handler.ErrorObject();
                ...
                try
                {
                    var bussines = CellarData.Select.GetCellarToArea(CellarArea);
                    if (!bussines.Item1.Error)
                    {
                        foreach (var item in bussines.Item2)
                        {
            ...
            public static GetCellarResponse GetCellarHome()
            {
                GetCellarResponse response = new GetCellarResponse();
                response.CellarList = new List<Cellars>();
                response.Error = new Handler.ErrorObject();
                ...
                try
                {
                    var bussines = CellarData.Select.GetCellarHome();
                    if (!bussines.Item1.Error)
                    {
                        foreach (var item in bussines.Item2)
                        {
            ...
            public static GetCellarResponse GetCellarByProductIDAndCellarArea(GetCellarRequest request)
            {
                ...
                try
                {
                    var bussines = CellarData.Select.GetCellarByProductIDAndCellarArea(request.ProductID, request.CellarAreaID, request.conditionID, request.TransactionTypeID);
                    if (!bussines.Item1.Error)
                    {
                        response.Cellar = new Cellars()
                        {
            ...
            public static GetCellarResponse GetCellarDataByProductIDAndCellarArea(GetCellarRequest request)
            {
                GetCellarResponse response = new GetCellarResponse();
                response.Error = new Handler.ErrorObject();
                response.Cellar = new Cellars();
