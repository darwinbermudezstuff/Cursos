...
namespace Data.Transaction
{
    public class TransactionConfigurateData
    {
        ...
        public class GetTransactionConfigurateDataResponse {
            ...
            public Nullable<int> TidConditionProduct { get; set; }
            public Nullable<System.DateTime> TexpeditionDate { get; set; }
        ...
        public class Select {
            ...
            /// <summary>
            /// Return All Transaction COnfiguraction Data By Current ID
            /// </summary>
