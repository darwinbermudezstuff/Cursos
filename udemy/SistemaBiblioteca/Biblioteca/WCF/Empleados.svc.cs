...
namespace Biblioteca.WCF
{
    ...
    // NOTE: In order to launch WCF Test Client for testing this service, please select Empleados.svc or Empleados.svc.cs at the Solution Explorer and start debugging.
